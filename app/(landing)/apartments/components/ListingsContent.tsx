...
export function ListingsContent() {
  ...
  const filteredListings = useMemo(() => {
    return ALL_LISTINGS.filter((listing: Listing) => {
      if (
      ...
      if (activeFilters.propertyType !== "All Types") {
        if (listing.unitType !== activeFilters.propertyType) return false;
      }
  ...
  const pageNumbers = getPageNumbers(page, realTotalPages);
